...
public class HttpBillingClient implements Client {
	...
	/*
	 * public Client(String serviceEndpoint) { this.serviceEndpoint =
	 * serviceEndpoint; this.restTemplate = new RestTemplate(); }
	 */

	public void BillingClient(RestTemplate restTemplate) {
